...
public sealed class GameData
{
    ...
    private void ResolveItems()
    {
        ...
        string[] wanted =
        [
            "Faded Remnant of Resilience", "Bright Remnant of Resilience", "Beastmaster's Horns", "Beastmaster's Furs",
            "Beastmaster's Boots", "Guttler", "Guttler Unleashed", "Kornago Hoplon", "Cu Sith Horn", "Tourmaline Golem Horn"
        ];
        foreach (var row in sheet)
        {
            var name = row.Name.ToString();
